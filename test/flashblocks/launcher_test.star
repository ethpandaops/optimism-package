flashblocks_websocket_proxy_launcher = import_module("/src/flashblocks/flashblocks-websocket-proxy/launcher.star")
...
def test_flashblocks_websocket_proxy_get_service_config_with_conductors(plan):
    ...
    conductor1 = struct(
        service_name="conductor-1-test-network",
        conductor_rpc_port=8547
    )
    conductor2 = struct(
        service_name="conductor-2-test-network", 
        conductor_rpc_port=8547
    )
    ...
    expected_upstream = "ws://conductor-1-test-network:8547/ws,ws://conductor-2-test-network:8547/ws"
...
def test_flashblocks_websocket_proxy_get_service_config_single_conductor(plan):
    ...
    conductor = struct(
        service_name="conductor-solo-test-network",
        conductor_rpc_port=8547
    )
