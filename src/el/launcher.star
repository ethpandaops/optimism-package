...
_op_rbuilder_launcher = import_module("/src/el/op-rbuilder/launcher.star")
...
def launch(
    ...
    elif params.type == "op-rbuilder":
        el = _op_rbuilder_launcher.launch(
            plan=plan,
            params=params,
            network_params=network_params,
            sequencer_params=sequencer_params,
