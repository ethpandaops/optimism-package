...
def launch(
    ...
    return struct(
        service=service,
        context=ethereum_package_el_context.new_el_context(
            client_name="op-geth",
            enode=enode,
...
def get_service_config(
    ...
    if network_params.network not in ethereum_package_constants.PUBLIC_NETWORKS:
    ...
    plan.print(">>>", params.image)
    plan.print(">>>", util.label_from_image(params.image))
